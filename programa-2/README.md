...
2. Compilar y ejecutar el programa en modo no interactivo, es decir, la entrada del programa serán todos los archivos `*.txt` dentro del directorio de ejecución y cada salida será almacenada en un archivo con el formato: `resultados-ejecucion-dia_mes_año-hora-minuto.out`.
...
Paso 4: Mostrar la solución (si existe).
...
Contenido de `input.txt` (único archivo para este ejemplo):
...
Resultados en `resultados-ejecucion-23_10_2020-20:45.txt`:
