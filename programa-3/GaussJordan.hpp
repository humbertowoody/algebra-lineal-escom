...
public:
  ...
  void diagonalizarMatriz();                                        // Realiza la diagonalizacion inferior de la matriz.
  void verificarTipoSolucion();                                     // Verifica e imprime qué tipo de solución tiene la matriz.
  void calcularSolucionFinal();                                     // Realiza el cálculo de la solución final para el sistema.
  int obtenerNumeroVariables() const { return numero_variables; }   // Regresa el número de variables.
  int obtenerNumeroEcuaciones() const { return numero_ecuaciones; } // Regresa el número de ecuaciones.
